...
import React, { FC, ComponentProps, ReactNode, useState, useCallback, useMemo } from 'react';
import { motion, useReducedMotion } from 'framer-motion';
import { Trigger, Content, Root, Group } from '@radix-ui/react-dropdown-menu';
...
const StyledContent = styled(Content)<{ tx?: BoxProps['tx'] }>(inlineStyles);
