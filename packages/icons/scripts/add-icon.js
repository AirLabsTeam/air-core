...
const generateTemplatesForFile = (fileName, relativePath) => {
  ...
  const typeMapLine = `\nexport const ${pascalFileName} = React.forwardRef<SVGSVGElement, Omit<SVGProps<SVGSVGElement>, 'css'>>((props, ref) => <${alias} {...props} ref={ref} />); ${pascalFileName}.displayName = '${pascalFileName}';`;
