...
export interface MultipleImagesProps extends Omit<SVGProps<SVGSVGElement>, 'css'> {}

export const MultipleImages = forwardRef<SVGSVGElement, MultipleImagesProps>((props, ref) => (
